...
<template>
    <div class="flex flex-col">
        <h1 class="text-5xl md:text-9xl uppercase pb-10">{{ projet.nom }}</h1>
        ...
        <div class="w-11/12 flex flex-col font-helveticaNeueThin">
            ...
            <p v-for="para in projet.desc.split('\\n')" class="text-end text-xs md:text-base uppercase mt-2 w-1/2 ml-auto">{{ para }}</p>
        ...
        <RouterLink to="/project" class="flex w-fit gap-4 text-2xl md:text-6xl items-center self-end pr-10 mb-10 uppercase"> <img
                src="/ArrowBack.png" alt="" class="h-9 md:h-auto"> Back to project</RouterLink>
    </div>
</template>