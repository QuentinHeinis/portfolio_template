...
<template>
    <div class="border-b ">
        <h1 class="uppercase text-4xl md:text-6xl lg:text-8xl xl:text-9xl w-1/3">All my Logos</h1>
        ...
        <div v-for="logo in data" class="w-full h-[28rem] border-t mt-10 flex justify-center flex-wrap gap-9 py-8">
            <div class="flex flex-col w-1/2 justify-center md:justify-end gap-4">
                <h2 class="text-2xl md:text-5xl lg:text-6xl xl:text-7xl uppercase ">{{ logo.nom }}</h2>
            </div>
